...
<body data-mobile-nav-style="classic">
    ...
    <!-- end header -->
    <!-- start banner -->
    <section class="top-space-padding position-relative cover-background background-position-center-top img-hero" style="background-image: url('image/p1n.jpg'); height:120vh;object-fit:cover; width:100%;background-color:rgba(255, 255, 255, 0.5);">
        <div class="container">
                ...
                <div class="col-11 col-lg-6 col-sm-7 mt-14 mb-14 sm-mt-10 sm-mb-10" data-anime='{ "el": "childs", "translateX": [30, 1], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="vertical-title-center align-items-center position-absolute left-minus-80px xl-left-minus-60px lg-left-minus-20px top-0px d-none d-xl-flex ">
                        <div class="title fs-15 text-paarvedan fw-700 text-uppercase ls-3px border-start border-color-dark-golden-yellow lh-10 pt-45px pb-45px">Help the poor children</div>
                            ...
                            <a href="donate.php" class="btn btn-large btn-round-edge with-rounded text-white bg-gradient-paarvedan btn-box-shadow">Donate Now<span class="bg-white"><i class="fa-solid fa-arrow-right color-paarvedan"></i></span></a>
                        </div>  
                </div>
            </div>
        </div>
                        ...
                        <div class="swiper overflow-x-visible" data-slider-options='{ "slidesPerView": 1, "spaceBetween": 28, "loop": true, "autoplay": { "delay": 2000, "disableOnInteraction": false }, "pagination": { "el": ".slider-four-slide-pagination-1", "clickable": true }, "navigation": { "nextEl": ".slider-one-slide-next-1", "prevEl": ".slider-one-slide-prev-1" }, "keyboard": { "enabled": true, "onlyInViewport": true }, "breakpoints": { "1200": { "slidesPerView": 4 }, "992": { "slidesPerView": 4 }, "768": { "slidesPerView": 3 }, "576": { "slidesPerView": 2 } }, "effect": "slide" }'>
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/1.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/2.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/3.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/4.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/5.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/6.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/7.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/8.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/9.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/10.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/11.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/12.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/13.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/14.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/15.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/16.png" alt="" />
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-box ps-40px pe-40px xl-ps-20px xl-pe-20px">
                                        <div class="feature-box-icon position-relative">
                                            <img class="custom-image-icon mt-30px mb-20px" src="image/17.png" alt="" />
            ...
            <div class="row align-items-center justify-content-center g-0 pt-60px">
                <div class="col-lg-6 icon-with-text-style-01 d-flex justify-content-md-center justify-content-start sm-border-bottom md-border-bottom border-color-extra-medium-gray border-end md-border-end-0" data-anime='{ "el": "childs", "translateX": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                    <div class="feature-box feature-box-left-icon-middle last-paragraph-no-margin md-mb-25px">
                        <div class="feature-box-icon me-20px">
                            <img src="image/volunteer.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-6 icon-with-text-style-01 d-flex justify-content-md-center justify-content-start icon-with-text-style-01 sm-pt-25px md-pt-25px" data-anime='{ "el": "childs", "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                    <div class="feature-box feature-box-left-icon-middle last-paragraph-no-margin">
                        <div class="feature-box-icon me-20px">
                            <img src="image/beneficiaries.jpg" alt="">
                        </div>
                        <div class="feature-box-content">
                                ...
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href="image/farmerwomen.jpg" data-group="lightbox-group-gallery-item-2" title="Paarvedan Gallery">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src="image/farmerwomen.jpg" style="width: 100%; height: 250px; object-fit: cover; object-position: center; display: block; border-radius: 5px;" alt="" />
                        ...
                        <li class="grid-item transition-inner-all">
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href="image/girldressasgodess.jpg" data-group="lightbox-group-gallery-item-2" title="Paarvedan Gallery">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src="image/girldressasgodess.jpg" style="width: 100%; height: 250px; object-fit: cover; object-position: center; display: block; border-radius: 5px;" alt="" />
                                                    <div class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-zoom-in icon-medium text-white"></i>
                                                    </div>
                                                </div>
                        ...
                        <li class="grid-item transition-inner-all">
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href="image/manwithload.jpg" data-group="lightbox-group-gallery-item-2" title="Paarvedan Gallery">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src="image/manwithload.jpg" style="width: 100%; height: 250px; object-fit: cover; object-position: center; display: block; border-radius: 5px;" alt="" />
                                                    <div class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-zoom-in icon-medium text-white"></i>
                                                    </div>
                                                </div>
                        ...
                        <li class="grid-item transition-inner-all">
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href="image/oldwoman.jpg" data-group="lightbox-group-gallery-item-2" title="Paarvedan Gallery">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src="image/oldwoman.jpg" style="width: 100%; height: 250px; object-fit: cover; object-position: center; display: block; border-radius: 5px;" alt="" />
                                                    <div class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-zoom-in icon-medium text-white"></i>
                                                    </div>
                                                </div>
                        ...
                        <li class="grid-item transition-inner-all">
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href="image/streetuncle.jpg" data-group="lightbox-group-gallery-item-2" title="Paarvedan Gallery">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src="image/streetuncle.jpg" style="width: 100%; height: 250px; object-fit: cover; object-position: center; display: block; border-radius: 5px;" alt="" />
                                                    <div class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-zoom-in icon-medium text-white"></i>
                                                    </div>
                                                </div>
                        ...
                        <li class="grid-item transition-inner-all">
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href="image/street.jpg" data-group="lightbox-group-gallery-item-2" title="Paarvedan Gallery">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src="image/street.jpg" style="width: 100%; height: 250px; object-fit: cover; object-position: center; display: block; border-radius: 5px;" alt="" />
                                                    <div class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-zoom-in icon-medium text-white"></i>
                                                    </div>
                                                </div>
                        ...
                        <li class="grid-item transition-inner-all">
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href="image/womenwithload.jpg" data-group="lightbox-group-gallery-item-2" title="Paarvedan Gallery">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src="image/womenwithload.jpg" style="width: 100%; height: 250px; object-fit: cover; object-position: center; display: block; border-radius: 5px;" alt="" />
                                                    <div class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-zoom-in icon-medium text-white"></i>
                                                    </div>
                                                </div>
                        ...
                        <li class="grid-item transition-inner-all">
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href="image/schoolstudent.jpg" data-group="lightbox-group-gallery-item-2" title="Paarvedan Gallery">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src="image/schoolstudent.jpg" style="width: 100%; height: 250px; object-fit: cover; object-position: center; display: block; border-radius: 5px;" alt="" />
                                                    <div class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-zoom-in icon-medium text-white"></i>
                                                    </div>
                                                </div>
