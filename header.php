    ...
    <div class="container-fluid justify-content-lg-start">
        <div class="col-auto">
            <a class="navbar-brand" href="./">
                <img src="image/pf-logo.png" data-at2x="image/pf-logo.png" alt="Paarvedan Foundation Logo" class="default-logo">
                <img src="image/pf-logo.png" data-at2x="image/pf-logo.png" alt="Paarvedan Foundation Logo" class="alt-logo">
                <img src="image/pf-logo.png" data-at2x="image/pf-logo.png" alt="Paarvedan Foundation Logo" class="mobile-logo">
            </a>
        </div>
        ...
        <div class="col-auto menu-order left-nav nav-compress-fix">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li  class="nav- item"><a href="corporate-employee-management.php " class="nav-link">Corporate</a></li>
                    <li  class="nav- item"><a href="ngo.php " class="nav-link">NGOs</a></li>
        ...
        <div class="col-auto ms-auto d-none d-lg-flex">
            <div class="header-icon">
                <div class="header-button ms-25px">
                    <a href="login.php" class="btn btn-small bg-button-paarvedan btn-hover-animation-switch btn-round-edge btn-box-shadow fw-700 ls-0px btn-icon-left">
                        <span>
                            <span class="btn-text">Login</span>
                            <span class="btn-icon"><i class="feather icon-feather-log-in"></i></span>
                            <span class="btn-icon"><i class="feather icon-feather-log-in"></i></span>
                ...
                <div class="header-button ms-25px">
                    <a href="donate.php" class="btn btn-small bg-button-alt-paarvedan btn-hover-animation-switch btn-round-edge btn-box-shadow fw-700 ls-0px btn-icon-left">
                        <span>
