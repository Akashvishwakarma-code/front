...
<head>
    <title>Corporate Employee Management | Paarvedan Foundation</title>
    <meta charset="utf-8">
...
<body data-mobile-nav-style="classic">
        ...
        <div class="container position-relative">
            <div class="row flex-column flex-lg-row justify-content-center align-items-lg-end extra-very-small-screen">
                <div class="col-xxl-8 col-md-7 position-relative page-title-large md-mb-30px sm-mb-20px">
                    <h1 class="text-white alt-font fw-500 ls-minus-1px mb-0" data-fancy-text='{ "opacity": [0, 1], "delay": 500, "speed": 50, "string": ["Corporate Employee Management"], "easing": "easeOutQuad" }'></h1>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-6 text-center text-lg-start" data-anime='{ "el": "childs", "willchange": "transform", "opacity": [0, 1], "rotateY": [-90, 0], "rotateZ": [-10, 0], "translateY": [80, 0], "translateZ": [50, 0], "staggervalue": 200, "duration": 600, "delay": 100, "easing": "easeOutCirc" }'>
                    ...
                    <a href="javascript:void(0)" class="btn btn-large btn-round-edge with-rounded bg-gradient-paarvedan text-white me-5" onclick="document.getElementById('apply-now').scrollIntoView({behavior: 'smooth'})">Apply now<span class="bg-white text-black"><i class="fa-solid fa-arrow-right color-paarvedan"></i></span></a>
            ...
            <div class="row g-0 justify-content-center">
                <div class="col-lg-8">
                    <div class="contact-form-style-01" data-anime='{ "translateX": [0, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h4 class="alt-font text-dark-gray highlight-separator-small">Corporate - Collaboration Form</h4>
                        <form id='myForm' enctype="multipart/form-data">

                            <div class="col-12">
                                <p class="fw-bold text-dark m-0">Corporate Details:</p>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="position-relative form-group mb-20px">
                                        ...
                                        <input type="text" name="corporate_name" class="form-control required" placeholder="Corporate Name*">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="position-relative form-group mb-20px">
                                        <span class="form-icon"><i class="bi bi-calendar"></i></span>
                                        <input type="date" name="year_of_establishment" class="form-control required" placeholder="Year of Establishment*">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="position-relative form-group mb-20px">
                                        ...
                                        <input type="number" name="number_of_employees" class="form-control required" placeholder="Number of Employees*">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="position-relative form-group form-textarea mb-20px">
                                ...
                                <textarea placeholder="Briefly outline the goals and objectives..." name="collaboration_objectives" class="form-control required" rows="4"></textarea>
                            </div>

                            <div class="col-12">
                                <p class="fw-bold text-dark m-0">Employee Welfare Initiatives:</p>
                                <hr class="w-25 border-top border-danger border-4 m-0 mb-3 rounded">
                            </div>

                            <div class="position-relative form-group form-textarea mb-20px">
                                <span class="form-icon"><i class="bi bi-heart-pulse"></i></span>
                                <textarea placeholder="Describe the current or planned employee welfare initiatives..." name="employee_welfare_initiatives" class="form-control" rows="4"></textarea>
                            </div>

                            <div class="col-12">
                                <p class="fw-bold text-dark m-0">Upload Supporting Corporate Documents:</p>
                                <hr class="w-25 border-top border-danger border-4 m-0 mb-3 rounded">
                            </div>

                            <div class="position-relative form-group mb-20px">
                                <label for="corporateprofile" class="form-label d-block">Corporate Profile / Overview:</label>
                                <input type="file" name="corporateprofile" id="corporateprofile" class="form-control">
                            </div>

                            <div class="position-relative form-group mb-20px">
                                <label for="welfarepolo" class="form-label d-block">Employee Welfare Policies:</label>
                                <input type="file" name="welfarepolo" id="welfarepolo" class="form-control">
                            </div>

                            <div class="position-relative form-group mb-20px">
                                <label for="fstatements" class="form-label d-block">Financial Statements:</label>
                                <input type="file" name="fstatements" id="fstatements" class="form-control">
                            </div>
                            ...
                            <div class="position-relative terms-condition-box text-start d-inline-block">
                                <label>
                                    ...
                                    <span class="box fs-16">I have reviewed the information and agree to the terms and conditions.*</span>
                                </label>
                            </div>
    ...
    <!-- <script>
        $(document).on('submit', '#myForm', async function(e) {
            ...
            const formData = new FormData(this); // 'this' yahan form element hai
