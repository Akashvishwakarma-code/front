...
<head>
    <title>ESG Women Empowerment | Paarvedan Foundation</title>
    <meta charset="utf-8">
...
<body data-mobile-nav-style="classic">
    ...
    <section class="page-title-separate-breadcrumbs bg-dark-gray ipad-top-space-margin cover-background bg-dark-gray"
        style="background-image: url(image/p9n.jpeg)">
            ...
            <div class="row flex-column flex-lg-row justify-content-center align-items-lg-end extra-very-small-screen">
                <div class="col-xxl-8 col-md-7 position-relative page-title-large md-mb-30px sm-mb-20px">
                    <h1 class="text-white alt-font fw-500 ls-minus-1px mb-0"
                        data-fancy-text='{ "opacity": [0, 1], "delay": 500, "speed": 50, "string": ["ESG Women Empowerment"], "easing": "easeOutQuad" }'>
                    </h1>
                </div>
                <div class="col-xxl-4 col-lg-5 col-md-7 col-sm-9 last-paragraph-no-margin" data-anime='{ "opacity": [0, 1], "delay": 500, "easing": "easeOutQuad" }'>
                    ...
                    <!-- Empowering women is also a part of our work. -->
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 order-lg-3 text-center">
                    <h6 class="alt-font text-dark-gray fw-600">ESG (Environmental, Social, and Governance)</h6>
                    <p class="w-100">Welcome to the Paarvedan Foundation's ESG (Environmental, Social, and Governance) & Women Empowerment collaboration initiative. We believe in the power of sustainable development and gender equality. If you are interested in collaborating with Paarvedan Foundation on projects related to ESG and Women Empowerment, please complete the following form.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0 justify-content-center">
                <div class="col-lg-8">
                    <div class="contact-form-style-01" data-anime='{ "translateX": [0, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h4 class="alt-font text-dark-gray highlight-separator-small">ESG - Application Form</h4>
                        <form id="myForm" enctype="multipart/form-data">

                            <!-- Organization Details -->
                            <div class="col-12">
                                <p class="fw-bold text-dark m-0">Organization Details:</p>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="position-relative form-group mb-20px">
                                        ...
                                        <input type="text" name="org_name" class="form-control required" placeholder="Organization Name*">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="position-relative form-group mb-20px">
                            ...
                            <div class="position-relative form-group mb-20px">
                                ...
                                <input type="text" name="nature_of_business" class="form-control required" placeholder="Nature of Business / Organization*">
                            </div>
                            ...
                            <!-- Collaboration Goals -->
                            <div class="col-12">
                                <p class="fw-bold text-dark m-0">Collaboration Goals:</p>
                                <hr class="w-25 border-top border-danger border-4 m-0 mb-3 rounded">
                            </div>

                            <div class="position-relative form-group form-textarea mb-20px">
                                <span class="form-icon"><i class="bi bi-bullseye"></i></span>
                                <textarea name="collab_goals" class="form-control required" rows="4" maxlength="200" placeholder="Briefly outline the goals and objectives of your collaboration with Paarvedan Foundation (Max 200 words)"></textarea>
                            </div>

                            <!-- Proposed Projects -->
                            <div class="col-12">
                                <p class="fw-bold text-dark m-0">Proposed Projects:</p>
                                <hr class="w-25 border-top border-danger border-4 m-0 mb-3 rounded">
                            </div>

                            <div class="position-relative form-group form-textarea mb-20px">
                                <span class="form-icon"><i class="bi bi-diagram-3"></i></span>
                                <textarea name="proposed_projects" class="form-control required" rows="4" maxlength="200" placeholder="Describe any ongoing or planned projects related to ESG and Women Empowerment (Max 200 words)"></textarea>
                            </div>
                            ...
                            <small class="text-muted d-block mb-1">Upload a proposal outlining your organization's commitment to ESG principles and Women Empowerment (PDF or Word):</small>
                            <div class="position-relative form-group mb-20px">
                                <span class="form-icon"><i class="bi bi-upload"></i></span>
                                <input type="file" name="esg_proposal" class="form-control" accept=".pdf,.doc,.docx">
                            </div>
                            ...
                            <div class="position-relative terms-condition-box text-start d-inline-block mb-3">
                                <p class="fs-16">
                                    ...
                                    I understand that collaboration with Paarvedan Foundation on ESG and Women Empowerment projects is subject to review and approval by the Foundation's team.
        ...
        if (btn) {
            ...
            btn.addEventListener('click', async function(e) {
                ...
                try {
                    ...
                    const response = await fetch('http://localhost:5000/api/forms/fesg-women', {
                        method: "POST",
                        body: formData
                    });
